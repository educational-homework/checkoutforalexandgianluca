...
namespace CryingSnow.CheckoutFrenzy
{
    public class MissionManager : MonoBehaviour
    {
        ...
        public void UpdateMission(Mission.Goal goalType, int progressAmount, int itemId = 0)
        {
            ...
            else if (currentMission.goalType == Mission.Goal.License)
            {
        ...
        public void AdvanceMission()
        {
            ...
            if (nextMission.goalType == Mission.Goal.License)
            {
                UpdateMission(Mission.Goal.License, 1, nextMission.targetId);
            }
        }
    }
}
